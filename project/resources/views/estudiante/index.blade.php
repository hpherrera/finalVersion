				...
				<div class="modal-body">
					...
					<div class="form-group has-feedback {{ $errors->has('fecha_limite') ? 'has-error': '' }}">
						...
						<div class="input-group date">
						  ...
						  <input type="text" class="form-control pull-right" name="fecha_limite" id="fecha_limite" autocomplete="off" required>
						</div>
					...
					<div class="form-group has-feedback {{ $errors->has('comentario') ? 'has-error': '' }}">
						...
						<input type="text" class="form-control" placeholder="EJ: entrevista 1 con pepito" name="comentario" autocomplete="off" required>
						</textarea>
