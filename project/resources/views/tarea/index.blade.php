			...
			<tbody>
			  @foreach($tareas as $tarea)
			    <tr>
			      ...
			      <td>{{ Carbon\Carbon::parse(ucfirst($tarea->fecha_limite))->format('d-m-Y')  }} 
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p> Recuerde que al eliminar la tarea se eliminaran los entregables, comentarios y notificaciones asociadas a esta.</p>
			</div>
